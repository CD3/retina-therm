...
def test_axial_part_fast_heat_flow_long_time_approx():
    ...
    assert G_approx( 0.0006, 0, 2e-5 ) == pytest.approx( G_exact(0.0006,0,2e-5),rel=0.02)
    assert G_approx( 0.00065, 0, 2e-5 ) == pytest.approx( G_exact(0.00065,0,2e-5),rel=0.02)
    ...
    with mp.workdps(200):
        assert G_approx(0.0006,0,3e-5) == pytest.approx( float(G_exact_mp(0.0006,0,3e-5)),rel=0.02)
        assert G_approx(0.00065,0,3e-5) == pytest.approx( float(G_exact_mp(0.00065,0,3e-5)),rel=0.02)

    with mp.workdps(1000):
        assert G_approx(0.0006,0,1e-3) == pytest.approx( float(G_exact_mp(0.0006,0,1e-3)),rel=0.01)
        assert G_approx(0.00065,0,1e-3) == pytest.approx( float(G_exact_mp(0.00065,0,1e-3)),rel=0.01)
